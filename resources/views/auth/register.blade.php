    ...
    <form method="POST" action="{{ route('register') }}">
                ...
                <li>
                    ...
                    <label for="player"
                        ...
                        <div class="block">
                            ...
                            <div class="w-full" style="font-size: 12px;">{{ __('messages.Регистрация как игрок') }}</div>
                        </div>
                ...
                <li>
                    ...
                    <label for="coach"
                        ...
                        <div class="block">
                            ...
                            <div class="w-full" style="font-size: 12px;">{{ __('messages.Регистрация как тренер') }}</div>
                        </div>
                        <svg class="w-5 h-5 ms-3 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                             fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="mt-4" id="code_field">
            ...
            <x-text-input id="team_code" class="block mt-1 w-full team_code" type="text" name="team_code"
                          :value="old('team_code')" autocomplete="team_code" placeholder="999-999"/>
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label for="password_confirmation" :value="__('messages.Подтверждения пароля')"/>
