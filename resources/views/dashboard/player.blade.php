@if (Auth::user()->active == 0)
    <div id="toast-danger"
        ...
        <div
            class="ms-3 text-sm font-normal">{{ __('messages.Ваш аккаунт не активен. Обратитесь к вашему тренеру, чтобы он вас активировал.') }}</div>
        <button type="button"
...
@else
    <h2 class="py-3 font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
        Ваша команда: {{ yourTeam() }}
    </h2>
    <div>
        @include('loadcontrol.quastions')
    </div>
@endif
