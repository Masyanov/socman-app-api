                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div>
                                <div
                                    class="font-medium text-xs text-gray-400 dark:text-gray-200">{{ Auth::user()->name }}</div>
                                <div
                                    class="font-medium text-xs text-gray-400 dark:text-gray-200">{{ Auth::user()->last_name }}</div>
                            </div>
                                        ...
                                        <g id="SVGRepo_iconCarrier">
                                            <g clip-path="url(#clip0_503_2726)">
                                                <rect x="0.25" y="0.25" width="27.5" height="19.5" rx="1.75"
                                                      fill="white" stroke="#F5F5F5" stroke-width="0.5"></rect>
                                                <mask id="mask0_503_2726" style="mask-type:alpha"
                                                      maskUnits="userSpaceOnUse" x="0" y="0" width="28" height="20">
                                                    <rect x="0.25" y="0.25" width="27.5" height="19.5" rx="1.75"
                                                          fill="white" stroke="white" stroke-width="0.5"></rect>
                                                </mask>
                                                <g mask="url(#mask0_503_2726)">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                          d="M0 13.3333H28V6.66667H0V13.3333Z" fill="#0C47B7"></path>
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                          d="M0 20H28V13.3333H0V20Z" fill="#E53B35"></path>
                                                </g>
                                            </g>
                                            <defs>
...
{{--                </x-responsive-nav-link>--}}
                ...
                @if(checkLoadControl())
                    <x-nav-link :href="route('loadcontrol.index')" :active="request()->routeIs('loadcontrol.index')">
                        <button type="button"
                                class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-full text-sm px-5 py-2.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">{{ __('Load Control') }}</button>
                    </x-nav-link>
                @endif
                            ...
                            <svg width="24px" height="24px" viewBox="0 -4 28 28" fill="none"
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <g clip-path="url(#clip0_503_2726)">
                                        ...
                                        <mask id="mask0_503_2726" style="mask-type:alpha" maskUnits="userSpaceOnUse"
                                        ...
                                        <g mask="url(#mask0_503_2726)">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                  d="M0 13.3333H28V6.66667H0V13.3333Z" fill="#0C47B7"></path>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M0 20H28V13.3333H0V20Z"
                                                  fill="#E53B35"></path>
                                        </g>
                                    </g>
                                    <defs>
