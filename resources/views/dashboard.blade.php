    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex flex-wrap gap-3 p-6 text-gray-900 dark:text-gray-100">
                    @if(Auth::user()->role == 'coach' || Auth::user()->role == 'admin')
                        <div class="flex flex-col items-center rounded-md w-5/12 sm:w-2/12 p-4 shadow-inner select-none" style="background: rgb(17 24 39);">
                        ...
                        <div class="flex flex-col items-center rounded-md w-5/12 sm:w-2/12 p-4 shadow-inner select-none" style="background: rgb(17 24 39);">
                            <div class="font-medium text-base text-gray-800 dark:text-gray-400">{{ __('messages.Явка') }} </div>
                            <div class="font-medium text-5xl text-gray-800 dark:text-gray-200">{{ presenceAll() }}%</div>
                            <div class="font-medium text-base text-gray-800 dark:text-gray-400">{{ __('messages.игроков') }}</div>
                        </div>
