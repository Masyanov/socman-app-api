...
class SubscriptionOrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $saveData = $request->only(['name','phone','email','subscription_type','customer_type']);
            ...
            return response()->json(['success' => false, 'message' => 'Произошла внутренняя ошибка. Попробуйте еще раз.'], 500);
        }
    }
}
